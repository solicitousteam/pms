    ...
    <div class="modal-body clearfix">
        <div class="container-fluid">
            ...
            <div class="form-group ml15">
                <i data-feather="check-circle" class='icon-16' style="color: #5CB85C;"></i> <?php echo app_lang('attached') . ' ' . anchor(get_uri("invoices/download_pdf/" . $invoice_info->id), get_invoice_id($invoice_info->id) . ".pdf", array("target" => "_blank")); ?> 
            </div>
