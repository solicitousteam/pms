...
<div id="page-content" class="clearfix">
    ...
    <ul id="team-member-view-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs rounded-0" role="tablist">
        ...
        <?php } ?>
            <li><a role="presentation" href="<?php echo_uri("team_members/overview/" . $user_info->id); ?>" data-bs-target="#tab-overview-info">Overview</a></li>
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane fade" id="tab-overview-info"></div>
        <?php
        foreach ($hook_tabs as $hook_tab) {
            ?>
    ...
    $(document).ready(function () {
        ...
        setTimeout(function () {
            ...
            if (tab === "general") {
                ...
                $("[data-bs-target='#tab-overview-info']").trigger("click");
            }
        }, 210);
